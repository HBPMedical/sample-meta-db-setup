...
This database contains the metadata of a sample data for testing and debugging purpose.
...
```console
$ docker run -i -t --rm -e FLYWAY_HOST=`hostname` hbpmip/sample-meta-db-setup:0.0.1 migrate
```
